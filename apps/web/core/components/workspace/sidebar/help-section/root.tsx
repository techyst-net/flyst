  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        <CustomMenu.MenuItem onClick={() => window.open("https://zeshan.local", "_blank")}>
        ...
        <CustomMenu.MenuItem onClick={() => window.open("mailto:sales@zeshan.local", "_blank")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
        ...
        <CustomMenu.MenuItem onClick={() => window.open("https://zeshan.local", "_blank", "noopener,noreferrer")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
