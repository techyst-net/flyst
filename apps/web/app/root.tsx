  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Flyst" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "Flyst - Modern project management" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "Flyst - Modern project management" },
];
